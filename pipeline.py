...
class pipeLineUI(MayaQWidgetDockableMixin, QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.import_version_pushButton.setHidden(True)
        ...
        self.ui.playblast_shot_pushButton.setHidden(True)
...
class pipeLine_projects_UI(QtGui.QMainWindow):
    def __init__(self, parent=None, pipeline_window=None):
        ...
        #print self.projectsTableView.model().sourceModel().items[0].name
        #self.populate_projects()
